...
# sys.path.append(osp.abspath('../../cluster-contrast-reid-main'))
...
from clustercontrast.models.baseline import *
...
def create_model(args):
    ...
    if not usemy:
        ...
        #创建模型
        model = Baseline(751, 1, 'cluster-contrast-reid-main/model/resnet50-0676ba61.pth', 'bnneck', 'after', 'resnet50', 'imagenet')
        #加载参数
        path="cluster-contrast-reid-main/model/resnet50_optimizer_center_80.pth"
